...
public class BooksTableModel implements TableModel{
	...
	public BooksTableModel(ResultSet booksResultSet)
	  ...
	  public void insertRow(int bookid, String title, String authorFirst, String authorLast,
	                        String genre, boolean checkedOut) throws SQLException {

	    try {
	      this.booksResultSet.moveToInsertRow();
	      this.booksResultSet.updateInt("BOOK_ID", bookid);
	      this.booksResultSet.updateString("TITLE", title);
	      this.booksResultSet.updateString("AUTHOR_FIRST", authorFirst);
	      this.booksResultSet.updateString("AUTHOR_LAST", authorLast);
	      this.booksResultSet.updateString("GENRE", genre);
	      this.booksResultSet.updateBoolean("CHECKED_OUT", checkedOut);
